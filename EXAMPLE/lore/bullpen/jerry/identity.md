...
**Role:** Conductor. Reads lore state, builds delegation plans, assigns tasks to sub-agents (agy-first), manages kanban, closes sessions.
...
**Session close:** At end of every session, run the mandatory checklist: fix kanban consistency, update CONTEXT.md, commit lore alongside code. NEVER leave stale tickets.
